...
from posenet_torch_solver import SolverPose
...
def main(config):
    ...
    solver = SolverPose(data_loader, config)
    if config.mode == 'train':
        solver.train()
    elif config.mode == 'test':
        solver.test()
    else:
        raise ValueError('Choose mode correctly!!')
...
if __name__ == "__main__":
    ...
    # default='/mnt/data2/image_based_localization/posenet/Street/dataset_train.txt')
    parser.add_argument('--metadata_path', type=str, default='/mnt/data2/NCLT/train_1m.txt')
    # parser.add_argument('--metadata_path', type=str,
    # default='/mnt/data2/complex_urban/urban08/image_convert/train.txt')
